...
export default {
  ...
  data: () => ({
    team: [
      { name: "Mark", role: "web developer", avatar: "/img1.png" },
      { name: "Daniyar", role: "Graphic designer", avatar: "/img2.png" },
      { name: "Serik", role: "web developer", avatar: "/img3.png" },
      { name: "langrenn", role: "Desktop developer", avatar: "/img4.png" },
    ]
  })
};
</script>